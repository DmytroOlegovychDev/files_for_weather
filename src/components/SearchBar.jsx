  ...
  return (
    <div className="relative w-full max-w-2xl" ref={searchRef}>
      ...
      {showSuggestion && (suggestion.length > 0 || searchLoading) && (
        <div
          className="absolute top-full left-0 right-0 mt-3 bg-white/10 backdrop-blur-xl border
       border-white/20 rounded-2xl shadow-2xl overflow-hidden z-50"
        >
          {searchLoading ? (
            ...
            suggestion.map((city, index) => {
              return (
                <button
                  className="w-full py-4 px-6 text-left hover:bg-white/10 transition-all
