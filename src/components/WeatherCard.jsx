    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 mb-6 ">
        ...
        {WeatherStats.map((stat, index) => {
          return (
            <div
              className="bg-white/5 backdrop-blur-sm rounded-2xl p-3 hover:bg-white/10 transition-all duration-300 group"
              key={index}
            >
      ...
      <div className=" grid grid-cols-2 gap-4">
        <div
          className=" bg-linear-to-r from-orange-500/20 to-yellow-500/20 backdrop-blur-sm rounded-2xl
        ...
        <div
          className=" bg-linear-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-2xl
